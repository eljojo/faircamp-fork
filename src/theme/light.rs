...
pub const LIGHT: ThemeVarsOklch = ThemeVarsOklch {
    background_1_lightness: HashableF32(92.34),
    background_2_lightness: HashableF32(82.0),
    background_3_lightness: HashableF32(70.0),
    background_accent_lightness_max: HashableF32(48.0),
    background_accent_lightness_min: HashableF32(28.0),
    background_middleground_lightness: HashableF32(60.0),
