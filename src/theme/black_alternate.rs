...
pub const BLACK_ALTERNATE: ThemeVarsOklch = ThemeVarsOklch {
    background_1_lightness: HashableF32(0.0),
    background_2_lightness: HashableF32(21.56),
    ...
    middleground_accent_lightness_min: HashableF32(42.0),
    middleground_lightness: HashableF32(50.0),
    veil_alpha: HashableF32(6.0)
};
