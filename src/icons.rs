...
pub fn volume(label: &str) -> String {
    formatdoc!(r#"
        <svg width="1em" height="1em" version="1.1" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            <title>{label}</title>
            <path class="knob" d="m34.34 12.99v14.379h-4.6406v-14.363a19.159 19.159 0 0 0-16.857 18.994 19.159 19.159 0 0 0 19.158 19.158 19.159 19.159 0 0 0 19.158-19.158 19.159 19.159 0 0 0-16.818-19.01z"/>
            <path class="passive_range" d="m32 3.209c-7.3439-1e-7 -14.688 2.7953-20.279 8.3867-11.183 11.183-11.183 29.376 0 40.559l2.8672-2.8672c-9.633-9.633-9.6308-25.189 2e-3 -34.822 9.633-9.633 25.187-9.633 34.82 0s9.6352 25.189 2e-3 34.822l2.8672 2.8672c11.183-11.183 11.183-29.376 0-40.559-5.5914-5.5914-12.935-8.3867-20.279-8.3867z"/>
