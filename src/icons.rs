...
pub fn download() -> String {
    formatdoc!(r#"
        <svg aria-hidden="true" width="1em" height="1em" version="1.1" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            <path d="m32.016 8.1211a2.9762 2.9762 0 0 0-2.9668 2.9844l0.085938 26.777-7.7129-7.7363a2.9762 2.9762 0 0 0-2.1055-0.875 2.9762 2.9762 0 0 0-2.1055 0.86914 2.9762 2.9762 0 0 0-0.003907 4.209l12.729 12.764a2.9764 2.9764 0 0 0 4.2148 0l12.674-12.703a2.9762 2.9762 0 0 0-0.00586-4.209 2.9762 2.9762 0 0 0-4.207 0.003906l-7.5254 7.541-0.083985-26.658a2.9762 2.9762 0 0 0-2.9863-2.9668zm-15.99 43.705c-1.6438 5e-3 -2.974 1.3425-2.9688 2.9863 5e-3 1.6438 1.3425 2.9721 2.9863 2.9668h31.945c1.6438 0.0053 2.9813-1.323 2.9863-2.9668 0.0053-1.6438-1.323-2.9813-2.9668-2.9863h-31.982z"/>
        </svg>
    "#)
}
