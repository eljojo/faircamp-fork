...
pub fn translations() -> Translations {
    Translations {
        ...
        audio_player_widget_for_release: String::from("Widget de reproductor de audio para todas las pistas de una grabación"),
        audio_player_widget_for_track: String::from("Widget de reproductor de audio para una pista"),
