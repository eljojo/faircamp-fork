...
pub fn translations() -> Translations {
    Translations {
        ...
        copy_link_to_track: String::from("Copia link al brano"),
...
- Puoi usare i colori dove ha senso - molte persone hanno perso la vista più tardi nella vita e comprendono e apprezzano i colori."),
        ...
        pay_on_liberapay: String::from("Paga su Liberapay:"),
        ...
        top: String::from("In alto"),
        tracks: String::from("Brani"),
