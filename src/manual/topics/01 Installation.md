...
Install the [.deb package (amd64) [libvips-enabled]](https://simonrepp.com/faircamp/packages/faircamp_0.1.0-1+deb12_amd64.deb)

**Debian 11, elementary OS, Linux Mint, Ubuntu 22.04 LTS - 22.10**

Install the [.deb package (amd64)](https://simonrepp.com/faircamp/packages/faircamp_0.1.0-1+deb11_amd64.deb)
