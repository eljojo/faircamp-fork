...
Install the [latest debian 12 package](https://simonrepp.com/faircamp/packages/faircamp_0.9.0-1+deb12_amd64.deb)

**Debian 11, elementary OS, Linux Mint, Ubuntu 22.04 LTS - 22.10**

Install the [latest debian 11 package](https://simonrepp.com/faircamp/packages/faircamp_0.9.0-1+deb11_amd64.deb)
