...
pub fn translations() -> Translations {
    Translations {
        ...
        audio_player_widget_for_release: reviewed!(r#"Audio player widget for the release "{title}""#),
        audio_player_widget_for_track: reviewed!(r#"Audio player widget for the track "{title}""#),
