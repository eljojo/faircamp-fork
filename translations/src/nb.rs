...
pub fn translations() -> Translations {
    Translations {
        ...
        audio_player_widget_for_release: reviewed!(r#"Lydavspillerelement for utgivelsen "{title}""#),
        audio_player_widget_for_track: reviewed!(r#"Lydavspillerelement for sporet "{title}""#),
