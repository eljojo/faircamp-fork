...
pub const PL: Translations = Translations {
    ...
    audio_player_widget_for_release: reviewed!(r#"Odtwarzacz audio dla wydania "{title}""#),
    audio_player_widget_for_track: reviewed!(r#"Odtwarzacz audio dla utworu "{title}""#),
