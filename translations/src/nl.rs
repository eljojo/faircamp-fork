...
pub fn translations() -> Translations {
    Translations {
        ...
        audio_player_widget_for_release: unreviewed!(r#"Audiospelerwidget voor de release "{title}""#),
        audio_player_widget_for_track: unreviewed!(r#"Audiospelerwidget voor de track "{title}""#),
