...
pub fn translations() -> Translations {
    Translations {
        ...
        audio_player_widget_for_release: reviewed!(r#"Audio Player Widget für den Release "{title}""#),
        audio_player_widget_for_track: reviewed!(r#"Audio Player Widget für den Track "{title}""#),
