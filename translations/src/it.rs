...
pub fn translations() -> Translations {
    Translations {
        ...
        audio_player_widget_for_release: reviewed!(r#"Widget del lettore audio per l'uscita "{title}""#),
        audio_player_widget_for_track: reviewed!(r#"Widget del lettore audio per il brano "{title}""#),
