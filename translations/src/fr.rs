...
pub fn translations() -> Translations {
    Translations {
        ...
        audio_player_widget_for_release: reviewed!(r#"Widget de lecteur audio pour l'album "{title}""#),
        audio_player_widget_for_track: reviewed!(r#"Widget de lecteur audio pour la piste "{title}""#),
