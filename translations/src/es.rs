...
pub const ES: Translations = Translations {
    ...
    audio_player_widget_for_release: unreviewed!(r#"Widget de reproductor de audio para la grabación "{title}""#),
    audio_player_widget_for_track: unreviewed!(r#"Widget de reproductor de audio para la pista "{title}""#),
